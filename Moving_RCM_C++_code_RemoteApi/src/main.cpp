...
void lorenz( const state_type &x , state_type &dx ,  double t)
{
    ...
    simxFloat q_0=0, q_1=0, q_2=0, q_3=0, q_4=0, q_5=0, q_6=0;
    ...
    {
        simxGetJointPosition(clientID, kinParams.lbrJoint[0], &q_0, simx_opmode_oneshot);
        simxGetJointPosition(clientID, kinParams.lbrJoint[1], &q_1, simx_opmode_oneshot);
        simxGetJointPosition(clientID, kinParams.lbrJoint[2], &q_2, simx_opmode_oneshot);
        simxGetJointPosition(clientID, kinParams.lbrJoint[3], &q_3, simx_opmode_oneshot);
        simxGetJointPosition(clientID, kinParams.lbrJoint[4], &q_4, simx_opmode_oneshot);
        simxGetJointPosition(clientID, kinParams.lbrJoint[5], &q_5, simx_opmode_oneshot);
        simxGetJointPosition(clientID, kinParams.lbrJoint[6], &q_6, simx_opmode_oneshot);
    ...
    for (int i=0; i<kinParams.q.size()-1;i++){
        if(x[i]>max_angle[i])
            simxSetJointTargetPosition(clientID, kinParams.lbrJoint[i], max_angle[i], simx_opmode_oneshot);
        else if(x[i]<-max_angle[i])
            simxSetJointTargetPosition(clientID, kinParams.lbrJoint[i], -max_angle[i], simx_opmode_oneshot);
        else
            simxSetJointTargetPosition(clientID, kinParams.lbrJoint[i], x[i], simx_opmode_oneshot);
    }
}
...
int main(int argc, char** argv){
  ...
  if (clientID != -1)
  {
     ...
     simxFloat q_0=0, q_1=0, q_2=0, q_3=0, q_4=0, q_5=0, q_6=0;
     simxFloat torque_0=0, torque_1=0, torque_2=0, torque_3=0, torque_4=0, torque_5=0, torque_6=0;
     simxFloat torque_=0;
     ...
     lbrJoint << lbrJoint1, lbrJoint2, lbrJoint3, lbrJoint4, lbrJoint5, lbrJoint6, lbrJoint7;
     kinParams.lbrJoint << lbrJoint1, lbrJoint2, lbrJoint3, lbrJoint4, lbrJoint5, lbrJoint6, lbrJoint7;
     ...
     for (int i=0; i<kinParams.q.size();i++){
         simxSetObjectFloatParameter(clientID, lbrJoint[i], 2017, upperVelocityLimit[i], simx_opmode_oneshot_wait);
     }

     char ch;
     // restart
     for (int i=0; i<kinParams.q.size();i++){
         simxSetJointTargetPosition(clientID, lbrJoint[i], q[i], simx_opmode_oneshot_wait);
     }
     ...
     simxFloat signalValue_fx;
     simxFloat signalValue_fy;
     simxFloat signalValue_fz;
     ...
     simxInt breathOn = 1;
     simxSetIntegerSignal(clientID, "breath", breathOn, simx_opmode_oneshot_wait);
